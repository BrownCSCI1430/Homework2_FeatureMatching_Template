...
For each pair, discuss any differences in the returned corners, the properties of the images that create these differences, and any underlying real world challenges that may have been the primary cause of these differences. In other words, what aspects of the image, objects, or environment determine what corners are detected? \textbf{[3--5 sentences]}
\end{question}
